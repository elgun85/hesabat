...
@section('title','Update new about')
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Update the about</h3>
                                </div>
                                ...
                                <form  method="POST" action="{{route('about.update',$about->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="rounded float-start " id="preview-image-before-upload"
                                                 src="@if($about->image) {{asset($about->image)}} @endif"
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" id="exampleInputEmail1" value="{{$about->name}}"  required>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$about->mail}}"  name="mail" id="exampleInputEmail1">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{$about->phone}} "  name="phone" id="exampleInputEmail1">
...
{{--                                                <input class="form-check-input" name="skills[]" type="checkbox" value="{{$pese->name}}"--}}
{{--                                                       @if(in_array($pese->name,$arr) )--}}
{{--                                                       checked--}}
{{--                                                       @endif--}}
{{--                                                       id="defaultCheck1">--}}
