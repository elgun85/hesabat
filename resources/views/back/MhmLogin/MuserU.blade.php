...
@section('title','İstifadəçilərin dəyişilməsi')
...
<div class="card-body">
         <div class="row ">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">İstifadəçini dəyiş</h3>
              </div>

              <form  method="POST" action="{{route('muser.update',$data->id)}}">
                  @method('PUT')
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">İstifadəçi adı</label>
                    <input type="text" class="form-control" name="login" id="exampleInputEmail1" value="{{$data->login}}"  required>
                ...
                <div class="form-group">
                  ...
                  <select  name="cat_id" class="form-control select2" style="width: 100%;"   onmousedown="if(this.options.length>5){this.size=5;}" onchange="this.blur()"  onblur="this.size=0;"   required>
                   <option value="{{$data->category[0]->id}}"  selected >{{$data->category[0]->sobe}}</option>
                ...
                <div class="form-group">
                  ...
                  <select name="vez_id" class="form-control select2" style="width: 100%;" onmousedown="if(this.options.length>5){this.size=5;}" onchange="this.blur()"  onblur="this.size=0;" required>
                   <option value="{{$data->vezife[0]->id}}"  selected >{{$data->vezife[0]->name}}</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="qeyd" id="exampleInputEmail1" value="{{$data->qeyd}}" >
...
{{--                      <td></td>--}}
                    <td>{{$login->qeyd}}</td>
                    <td>
          <a href="{{route('muser.index')}}" class="btn btn-outline-success btn-sm" ><i class="fas fa-plus"></i></a>
