...
@section('title','Kateqoriya elave et')
@section('content')
        ...
        <div class="card-body">
         <div class="row">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Mhm login üçün yeni şöbələr əlavə et</h3>
              </div>
              ...
              <form  method="POST" action="{{route('category.store')}}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sobe" id="exampleInputEmail1" placeholder="Şöbənin adı" {{old('sobe')}} required>
