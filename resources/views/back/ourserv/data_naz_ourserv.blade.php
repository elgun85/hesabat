...
@section('title','Data nazirlik ourserv')
            ...
            <div class="card">
                <div class="card-header" >
                    <div class="card-title">
                        <form action="{{route('data_naz_ourserv')}}" method="get" name="formdan">
                            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 text-right"> <button id="exporttable" class="btn btn-primary">Excel</button>
                            </div>
                    </div>
                        {{--                cedvel evvel --}}
