...
@section('title','1.'.request()->get('ay').'.'.request()->get('il').' -tarixə Aylıq Texniki xidmet(289) üzrə hesabat')
                    ...
                    <div class="col-sm-6">
                        <h1>
                            @if((request()->get('il')) and (request()->get('ay')) )
                             1.{{request()->get('ay')}}.{{ request()->get('il')}} Aylıq Texniki xidmet(289) üzrə hesabat
                            @endif
                        </h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <form action="{{route('texXid')}}" method="get" name="formdan">
                            @csrf
