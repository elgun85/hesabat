...
@section('title',request()->get('ay').' '.request()->get('il').' Aylıq hesablanma  üzrə hesabat')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <form action="{{route('hesablanma')}}" method="get" name="formdan">
                            @csrf
                            <div class="form-row align-items-center">
                                                                ...
                                                                <div class="col-auto">
                                                                    <select id = "mltislct" multiple = "multiple" name="ay">
                                                                        @if(request()->get('ay') !=0)
