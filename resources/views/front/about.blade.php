...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="{{$abouts->image}}" class="img-fluid" alt="">
                </div>
...
{{--                                <li><i class="bi bi-rounded-right"></i> <strong>Phone:</strong> {{$abouts->phone}} </li>--}}
...
{{--                @endphp--}}
                @foreach($skills as $pese)
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            <span class="skill">{{$pese->name}} <i class="val">{{$pese->dagress}}%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="{{$pese->dagress}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
